...
export const INFRA_RESOURCE_DROP_PERCENT = 0.5;
...
export const FACTIONS: readonly Faction[] = Object.freeze([
  ...
  { id: 'f3', name: 'The Sunfire Dynasty', color: 'yellow-600', archetype: 'Holy', traits: [{ name: 'Devout', description: 'Population grows 10% faster and their mages (Ranged) deal 10% more damage.', effects: [{ type: 'POP_GROWTH_MOD', value: 0.1 }, { type: 'UNIT_STAT_MOD', stat: 'atk', unitRole: 'Ranged', value: 0.1 }] }], preferredBiomes: ['verdant', 'tundra'], personality: { aggression: 7, expansion: 7, diplomacy: 4 }, techTreeId: 'sunfire_tech' },
  ...
  { id: 'f6', name: 'Sylvan Elves', color: 'teal-400', archetype: 'Nature', traits: [{ name: 'Woodland Archers', description: 'Their ranged units are exceptionally skilled, dealing 15% more damage.', effects: [{ type: 'UNIT_STAT_MOD', stat: 'atk', unitRole: 'Ranged', value: 0.15 }] }], preferredBiomes: ['gloomwell', 'verdant'], personality: { aggression: 4, expansion: 3, diplomacy: 9 }, techTreeId: 'elf_tech' },
  ...
  { id: 'f8', name: 'Crimson Horde', color: 'orange-500', archetype: 'Nomadic', traits: [{ name: 'WAAAGH!', description: 'Their melee units are filled with battle rage, dealing 10% more damage.', effects: [{ type: 'UNIT_STAT_MOD', stat: 'atk', unitRole: 'Melee', value: 0.1 }] }], preferredBiomes: ['wasteland', 'ashlands'], personality: { aggression: 10, expansion: 7, diplomacy: 0 }, techTreeId: 'horde_tech' },
...
export const UNITS: readonly UnitDefinition[] = Object.freeze([
    ...
    { id: 'gearforged_soldier', name: 'Gear-Forged Soldier', factionId: 'f1', hp: 110, atk: 12, defense: 10, role: 'Melee', assetId: 'unit_soldier_gearforged', cost: { 'iron_ingot': 20, 'clockwork_gear': 5 }, tier: 1, traitIds: ['armored'] },
    { id: 'clockwork_marksman', name: 'Clockwork Marksman', factionId: 'f1', hp: 70, atk: 15, defense: 0, role: 'Ranged', assetId: 'unit_archer_clockwork', cost: { 'steamwood_plank': 10, 'clockwork_gear': 8 }, tier: 1, traitIds: ['long_range'] },
    { id: 'steam_hulk', name: 'Steam Hulk', factionId: 'f1', hp: 250, atk: 25, defense: 20, role: 'Special', assetId: 'unit_golem_steam', cost: { 'iron_ingot': 50, 'athar_capacitor': 2 }, tier: 3, traitIds: ['armored', 'siege_weapon'] },
    ...
    { id: 'thorn_slinger', name: 'Thorn Slinger', factionId: 'f2', hp: 50, atk: 12, defense: 0, role: 'Ranged', assetId: 'unit_archer_thorn', cost: { 'steamwood_log': 15 }, tier: 1, traitIds: ['long_range'] },
    { id: 'grove_guardian', name: 'Grove Guardian', factionId: 'f2', hp: 200, atk: 18, defense: 25, role: 'Special', assetId: 'unit_golem_wood', cost: { 'steamwood_plank': 40, 'fluxbloom': 5 }, tier: 3, traitIds: ['armored'] },
    ...
    { id: 'sun_templar', name: 'Sun Templar', factionId: 'f3', hp: 130, atk: 15, defense: 15, role: 'Melee', assetId: 'unit_soldier_templar', cost: { 'iron_ingot': 25, 'refined_chronocrystal': 5 }, tier: 1, traitIds: ['armored'] },
    { id: 'technomancer', name: 'Technomancer', factionId: 'f3', hp: 65, atk: 18, defense: 0, role: 'Ranged', assetId: 'unit_mage_technomancer', cost: { 'refined_chronocrystal': 10, 'clockwork_gear': 8 }, tier: 1, traitIds: ['long_range'] },
    { id: 'aether_cannon', name: 'Athar Cannon', factionId: 'f3', hp: 90, atk: 40, defense: 5, role: 'Special', assetId: 'unit_siege_cannon', cost: { 'clockwork_gear': 20, 'athar_capacitor': 3 }, tier: 3, traitIds: ['siege_weapon'] },
    ...
    { id: 'syndicate_thug', name: 'Syndicate Thug', factionId: 'f4', hp: 70, atk: 10, defense: 5, role: 'Melee', assetId: 'unit_syndicate_thug', cost: { 'iron_ingot': 8 }, tier: 1, traitIds: ['feral_strength'] },
    { id: 'flux_alchemist', name: 'Flux Alchemist', factionId: 'f4', hp: 60, atk: 16, defense: 0, role: 'Ranged', assetId: 'unit_mage_alchemist', cost: { 'fluxbloom': 10 }, tier: 1 },
    { id: 'shadow_stalker', name: 'Shadow Stalker', factionId: 'f4', hp: 80, atk: 20, defense: 0, role: 'Ranged', assetId: 'unit_rogue_shadow', cost: { 'iron_ingot': 15, 'fluxbloom': 15 }, tier: 2, traitIds: ['long_range'] },
    ...
    { id: 'dwarf_warrior', name: 'Dwarf Warrior', factionId: 'f5', hp: 150, atk: 14, defense: 15, role: 'Melee', assetId: 'unit_dwarf_warrior', cost: { 'iron_ingot': 25 }, tier: 1, traitIds: ['armored'] },
    { id: 'dwarf_thunderer', name: 'Dwarf Thunderer', factionId: 'f5', hp: 100, atk: 20, defense: 5, role: 'Ranged', assetId: 'unit_dwarf_thunderer', cost: { 'iron_ingot': 15, 'clockwork_gear': 5 }, tier: 1, traitIds: ['long_range'] },
    ...
    { id: 'elf_longbow', name: 'Elf Longbow', factionId: 'f6', hp: 60, atk: 18, defense: 0, role: 'Ranged', assetId: 'unit_elf_longbow', cost: { 'steamwood_plank': 15 }, tier: 1, traitIds: ['long_range'] },
    { id: 'elf_bladedancer', name: 'Elf Bladedancer', factionId: 'f6', hp: 90, atk: 22, defense: 5, role: 'Melee', assetId: 'unit_elf_bladedancer', cost: { 'steamwood_plank': 10, 'iron_ingot': 10 }, tier: 2, traitIds: ['feral_strength'] },
    ...
    { id: 'skeleton_scout', name: 'Skeleton Scout', factionId: 'f7', hp: 30, atk: 8, defense: 0, role: 'Ranged', assetId: 'unit_skeleton_scout', cost: {}, tier: 1, traitIds: ['undying'] },
    ...
    { id: 'bone_golem', name: 'Bone Golem', factionId: 'f7', hp: 220, atk: 20, defense: 20, role: 'Special', assetId: 'unit_bone_golem', cost: { 'iron_ingot': 30 }, tier: 3, traitIds: ['armored', 'undying'] },
    ...
    { id: 'orc_hunter', name: 'Orc Hunter', factionId: 'f8', hp: 90, atk: 12, defense: 0, role: 'Ranged', assetId: 'unit_orc_hunter', cost: { 'iron_ore': 10 }, tier: 1, traitIds: ['feral_strength'] },
    { id: 'orc_brute', name: 'Orc Brute', factionId: 'f8', hp: 140, atk: 16, defense: 5, role: 'Melee', assetId: 'unit_orc_brute', cost: { 'iron_ore': 15 }, tier: 1, traitIds: ['feral_strength'] },
    { id: 'orc_berserker', name: 'Orc Berserker', factionId: 'f8', hp: 100, atk: 25, defense: 0, role: 'Melee', assetId: 'unit_orc_berserker', cost: { 'iron_ore': 20 }, tier: 2, traitIds: ['feral_strength'] },
    ...
    { id: 'scrapfang', name: 'Scrapfang', factionId: 'neutral_hostile', hp: 80, atk: 12, defense: 5, role: 'Melee', assetId: 'unit_beast_scrapfang', cost: {}, tier: 1, traitIds: ['feral_strength'] },
    { id: 'aetherwing', name: 'Aetherwing', factionId: 'neutral_hostile', hp: 60, atk: 10, defense: 0, role: 'Ranged', assetId: 'unit_beast_aetherwing', cost: {}, tier: 1, traitIds: ['feral_strength'] },
    { id: 'bandit_raider', name: 'Bandit Raider', factionId: 'neutral_hostile', hp: 70, atk: 10, defense: 3, role: 'Melee', assetId: 'unit_bandit_raider', cost: {}, tier: 1 },
    { id: 'goblin_raider', name: 'Goblin Raider', factionId: 'neutral_hostile', hp: 50, atk: 8, defense: 0, role: 'Melee', assetId: 'unit_goblin_raider', cost: {}, tier: 1 },
]);
...
export const BIOME_PASTEL_COLORS: Record<string, string> = {
    ...
    verdant: '#27ae60',   // Vivid Green
    wasteland: '#d35400', // Burnt Orange
    tundra: '#bdc3c7',    // Silver/Ice
