            ...
            <div className="relative w-full h-full flex flex-col items-center justify-center text-center p-4">
                <div className="bg-gray-900/70 backdrop-blur-md p-8 rounded-xl border border-cyan-500/30 shadow-2xl w-full max-w-md pop-in">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label htmlFor="username" className="block text-left text-sm font-medium text-gray-300 mb-1">Username</label>
                            <input
                                id="username"
                                type="text"
                                value={username}
                    ...
                    <div className="mt-6">
                         <p className="text-cyan-300 text-base font-mono copyright-glow text-center">© 2025 Rangga x Atharrazka</p>
                    </div>
                </div>
            </div>
        </div>
