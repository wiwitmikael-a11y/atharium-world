  ...
  return (
    <div className="relative w-screen h-screen bg-black overflow-hidden">
      ...
      <div className="relative w-full h-full flex flex-col items-center justify-center text-center p-4">
        <div className="bg-gray-900/50 backdrop-blur-xl p-8 sm:p-12 rounded-2xl border-2 border-cyan-500/30 shadow-2xl shadow-cyan-400/20 w-full max-w-lg pop-in">
